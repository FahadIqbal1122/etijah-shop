@extends('layouts.app')
@section('title', 'Terms & Conditions — Etijah Coaching')
...
<section class="bg-white border-b border-slate-200">
    <div class="max-w-3xl mx-auto px-6 py-14">
        ...
        <h1 class="font-display text-4xl font-bold text-slate-900 mb-3">Terms & Conditions</h1>
...
<section class="max-w-3xl mx-auto px-6 py-12">
    <div class="bg-white rounded-2xl border border-slate-200 p-8 md:p-12 prose prose-slate max-w-none">
        <p class="text-slate-500 leading-relaxed">
            These terms and conditions will be updated soon. Please check back later.
        </p>
    </div>
</section>
