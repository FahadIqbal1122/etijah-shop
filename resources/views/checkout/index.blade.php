...
<section class="max-w-5xl mx-auto px-6 py-14">
  ...
  focus:border-transparent transition"                                                                                                                                                                                                           placeholder="Ahmed">
                              ...
                              <div>
                                  ...
                                  <input type="text" name="last_name" required
                                      class="w-full border border-slate-200 rounded-xl px-4 py-3 text-sm text-slate-800 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-brand-500
  focus:border-transparent transition"                                                                                                                                                                                                           placeholder="Al-Mansoori">
                              </div>
                          </div>
  ...
  focus:border-transparent transition"
                          ...
                          <div class="pt-2 border-t border-slate-100">
                              <h2 class="text-base font-semibold text-slate-800 mb-5">Payment</h2>

                              {{-- Tap Payments will inject their card element here --}}
                              <div id="tap-card-element" class="border border-slate-200 rounded-xl px-4 py-3 min-h-[52px] bg-white">
                                  {{-- Tap Payments SDK renders here --}}
                              </div>                                                                                                                                                                       
                              <p class="text-xs text-slate-400 mt-2 flex items-center gap-1.5">
                                  <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                                      <path stroke-linecap="round" stroke-linejoin="round" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"/>
                                  </svg>
                                  Payments are secured and encrypted via Tap Payments
                              </p>
                          </div>
                      </div>
          ...
          <div class="lg:col-span-2">
              <div class="bg-white rounded-2xl border border-slate-200 p-7 sticky top-24">
                  <h2 class="text-base font-semibold text-slate-800 mb-5">Order Summary</h2>
                                                                                                                                                                                                                             <div class="flex items-start gap-4 pb-5 border-b border-slate-100">                                                                                                                                            <div class="w-11 h-11 bg-brand-700 rounded-xl flex items-center justify-center shrink-0">
